...
parser.add_argument('--classes', type=str, default='',
                    help="(Required) List of classes to label, e.g. ['banana','orange']. Note: no blank space in between")
parser.add_argument('--input_folder', type=str, default='', help='(Required) Path to folder of images to be annotated')
parser.add_argument('--output_folder', type=str, default=None,
                    help='Path to folder where annotated images(dataset) will be saved')
parser.add_argument('--extension', type=str, default='.jpeg',
                    help="Extension of images to be annotated, e.g. ['jpeg', 'png', 'jpg']")
